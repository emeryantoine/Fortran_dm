program main
	...
	call system("clear")
	print *, "Bonsoir ! Et bienvenue dans ce merveilleux devoir maison de fortran portant sur les &
	polynomes du 2nd degré et le calcul de racines réelles. Alors, il va falloir me donner &
	3 nombres entiers a, b, c pour créer le polynome :"
	print *, "ax² + bx + c"
	print *, " "
	print *, "a = ?		b = ?		c =?"
	print *, " "
